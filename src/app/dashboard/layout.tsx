  ...
  const navLinks = (
    <>
      ...
      {isAdmin && (
        <Link
          href="/admin"
          className="flex items-center rounded-lg px-3 py-2 text-sm font-medium text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/30"
        >
          <svg className="mr-3 h-5 w-5 text-red-400 dark:text-red-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        ...
        <header className="border-b border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900 px-6 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <Link href="/" className="text-xl font-bold text-gray-900 dark:text-white md:hidden">
                AskDocs
              </Link>
            </div>
