    ...
    <div className="max-w-3xl">
      ...
      <div className="mt-10 grid gap-6 sm:grid-cols-2">
        ...
        <Link
          ...
          className="group rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 transition hover:border-blue-300 dark:hover:border-blue-700 hover:shadow-md"
        >
          ...
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">{c.userGuide.description}</p>
        ...
        >
          ...
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">{c.developerGuide.description}</p>
          <span className="mt-4 inline-flex items-center text-sm font-medium text-blue-600 dark:text-blue-400">
      ...
      {/* Quick Links */}
      <div className="mt-12">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500">{c.quickLinks.title}</h3>
...
function QuickLink({ href, label, description }: { href: string; label: string; description: string }) {
  return (
    <Link
      href={href}
      className="flex items-center gap-3 rounded-lg border border-gray-100 dark:border-gray-800 px-4 py-3 transition hover:border-gray-200 dark:hover:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800"
    >
      <svg className="h-4 w-4 shrink-0 text-gray-400 dark:text-gray-500" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
      </svg>
      <div>
