  ...
  return (
    <div
      className={`rounded-xl border-2 p-6 ${
        isCurrent ? 'border-blue-500 bg-blue-50 dark:border-blue-600 dark:bg-blue-900/20' : 'border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900'
      }`}
    >
      <div className="mb-4">
      ...
      {isCurrent ? (
        <button
          disabled
          className="w-full rounded-lg bg-blue-100 dark:bg-blue-900/30 px-4 py-2.5 text-sm font-medium text-blue-700 dark:text-blue-400 cursor-default"
        >
          Current Plan
        </button>
      ) : onSelect ? (
...
function CheckIcon() {
  return (
    <svg className="h-4 w-4 text-green-500 dark:text-green-400 shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
